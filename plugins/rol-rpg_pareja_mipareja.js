...
conn.sendButton(m.chat, `🤨 𝑷𝒂𝒓𝒆𝒄𝒆 𝒒𝒖𝒆 *${await conn.getName(persona)}* 𝑵𝒐 𝒉𝒂 𝒂𝒄𝒆𝒑𝒕𝒂𝒅𝒐 𝒏𝒊 𝒓𝒆𝒄𝒉𝒂𝒛𝒂𝒅𝒐 𝒕𝒖 𝒑𝒓𝒐𝒑𝒖𝒆𝒔𝒕𝒂 𝒅𝒆 𝒆𝒔𝒕𝒂𝒓 𝒂𝒎𝒃𝒐𝒔 𝒆𝒏 𝒖𝒏𝒂 𝒓𝒆𝒍𝒂𝒄𝒊𝒐́𝒏`, `*_Vista la situación se anulará este pendiente_*\n\n` + wm, null, [
