...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '𝗠𝗮𝗳𝘂𝘆𝘂-𝗯𝗼𝘁 ', thumbnailUrl: await(await fetch(global.img)).buffer(), sourceUrl: yt }}}
...
if(!text && !m.quoted) return await conn.sendButton(m.chat, `𝙌𝙪𝙞𝙚́𝙣?🤔  𝙀𝙩𝙞𝙦𝙪𝙚𝙩𝙖𝙨 𝙤 𝙧𝙚𝙨𝙥𝙤𝙣𝙙𝙚 𝙪𝙣 𝙢𝙚𝙣𝙨𝙖𝙟𝙚 𝙙𝙚 𝙡𝙖 𝙥𝙚𝙧𝙨𝙤𝙣𝙖 𝙦𝙪𝙚 𝙦𝙪𝙞𝙚𝙧𝙚 𝙦𝙪𝙚 𝙨𝙚𝙖 𝙩𝙪 𝙥𝙖𝙧𝙚𝙟𝙖`, wm, null, [
...
if(!users) return await conn.sendButton(m.chat, `𝑵𝒐 𝒔𝒆 𝒆𝒏𝒄𝒐𝒏𝒕𝒓𝒐́ 𝒍𝒂 𝒑𝒆𝒓𝒔𝒐𝒏𝒂 𝒑𝒊𝒏𝒄𝒉𝒆́ 𝒑𝒆𝒏𝒅𝒆𝒋𝒐 🙄 𝒅𝒆𝒃𝒆 𝒅𝒆 𝒆𝒔𝒕𝒂𝒓 𝒆𝒏 𝒆𝒔𝒕𝒆 𝒈𝒓𝒖𝒑𝒐`, wm, null, [
['𝗠 𝗘 𝗡 𝗨 ☘️', '/menu']], fkontak, m)
...
return await conn.sendButton(m.chat, `𝑵𝒐 𝒑𝒖𝒆𝒅𝒆𝒔 𝒓𝒆𝒄𝒉𝒂𝒛𝒂𝒓 𝒂 *${tu}* 𝑺𝒊 𝒏𝒊𝒏𝒈𝒖𝒏𝒐 𝒔𝒆 𝒉𝒂 𝒅𝒆𝒄𝒍𝒂𝒓𝒂𝒅𝒐, 𝒅𝒆𝒄𝒍𝒂𝒓𝒂𝒕𝒆 𝒑𝒂𝒓𝒂 𝒒𝒖𝒆 𝒅𝒊𝒈𝒂 𝒔𝒊 𝒕𝒆 𝒂𝒄𝒆𝒑𝒕𝒂 𝒐 𝒏𝒐`, wm, null, [
